...
public class BattleEngine {
    ...
    private void executeTurn(Combatant combatant) {
        ...
        if (combatant instanceof Player) {
            usedSpecialSkill = executePlayerTurn((Player) combatant);
            ...
            case "3":
                if (player.hasItems()) {
                    ...
                    if (selectedItem != null) {
                        ...
                        usedSpecialSkill = selectedItem.triggersSpecialSkill();
                    }
                } else {
    ...
    private void displayDefeatScreen() {
        ...
        System.out.println();
        System.out.println("Statistics:");
        System.out.println("  Enemies remaining: " + getAliveEnemyCount());
